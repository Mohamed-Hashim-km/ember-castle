          ...
          <div className="flex flex-col justify-between py-6">
            <div className="flex flex-col items-start gap-8 lg:gap-10">
              ...
              <p className="text-secondary text-base md:text-lg leading-relaxed font-light text-opacity-80 max-w-lg lg:pr-8">
                Nestled within Gokarna's serene coastal landscape, Ember Castle by Éden offers a distinguished retreat just 2.6km from the shoreline.
                Surrounded by landscaped greenery and the soft hum of the forest, the estate delivers privacy, proximity, and comfort in equal
            ...
            <div className="md:mt-16 lg:mt-auto pt-8">
              <div className="flex flex-col items-start">
                <span className="text-xl md:text-2xl font-medium tracking-wide text-[#001446]">4.3 Stars</span>
                <span className="text-sm md:text-base text-[#001446] font-medium opacity-80 mt-1 mb-4">Average Rating by Past Guests</span>
